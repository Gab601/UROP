...
public class BodyDetectionTest {
    ...
    public static void RemoveBackground(String inputPath, String outputPath) {
        ...
        map.put("api_key", "5XYKQoOXdoiTxZpdcgasVUI8MmA49-8-");
        map.put("api_secret", "XBfifHLdaK_reDWZolPNeN_8btk9Ruqh");
        byteMap.put("image_file", buff);
        try {
            byte[] bacd = post(url, map, byteMap);
            String str = new String(bacd);
            String[] strArr = str.split("\"");
            Base64Converter decoder = new Base64Converter();
            byte[] imageArr = decoder.decode(strArr[3]);
            try {
